...
**Part 1** - Clean the [PanTHERIA database](https://esajournals.onlinelibrary.wiley.com/doi/10.1890/08-1494.1) from the [previous exercise](https://biodiversitydata.github.io/data-access/#/exercise---accessing-data)
...
**Part 2** - Create a reference table from GBIF occurrences downloaded [previously](https://biodiversitydata.github.io/data-access/#/exercise---accessing-data)
